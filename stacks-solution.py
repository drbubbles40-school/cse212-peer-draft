...
class Word:
    ...
    def typed(self, value_typed):
        ...
        #BONUS
        self.discard = Stack() #reset the discard stack
    ...
    def undo(self):
        ...
        if self.history.empty():
            print('Processor cannot undo.')
        else:
            self.discard.push(self.history.pop())
    ...
    def redo(self):
        ...
        if self.discard.empty():
            print('Processor cannot redo.')
        else:
            self.history.push(self.discard.pop())
...
processor.display()   #Testing the Redo Function
